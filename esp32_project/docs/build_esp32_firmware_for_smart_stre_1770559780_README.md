# Build ESP32 firmware for smart street light system: LDR on GPIO 34, LED on GPIO 2, if light level is low turn ON LED. Also show readings on OLED SSD1306 and output on Serial. Give full wiring and install guide.

**Auto-generated Documentation**  
*Generated: 2026-02-08 19:42:32*
...
This embedded systems project implements: **Build ESP32 firmware for smart street light system: LDR on GPIO 34, LED on GPIO 2, if light level is low turn ON LED. Also show readings on OLED SSD1306 and output on Serial. Give full wiring and install guide.**
...
## Project: Build ESP32 firmware for smart street light system: LDR on GPIO 34, LED on GPIO 2, if light level is low turn ON LED. Also show readings on OLED SSD1306 and output on Serial. Give full wiring and install guide.
...
|---------------|----------|--------|
| ldrPin | GPIO34 | const declaration |
| ledPin | GPIO2 | const declaration |
| minLightLevel | GPIO500 | const declaration |
