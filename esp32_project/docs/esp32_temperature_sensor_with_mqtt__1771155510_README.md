...
graph TD
    ...
    ESP32 -->|GPIO 0| LED (Digital Output)
...
Arduino CLI:
```bash
arduino-cli lib install ESP32-MQTT
```

Arduino IDE:
1. Open Library Manager.
2. Search for `ESP32-MQTT`.
...
Code Generation Time: 382.71s
Compilation Time: 168.71s
Memory Usage: 0.35%
Flash Usage: N/A
RAM Usage: 0.35%
Lines of Code: 54
...
- Code readability assessment: quality score reported as 85.
