# Generate firmware for ESP32 + DHT11 on GPIO 4. Read temperature and humidity every 2 seconds and print to Serial. Provide documentation and missing libraries.

**Auto-generated Documentation**  
*Generated: 2026-02-02 22:00:21*
...
This embedded systems project implements: **Generate firmware for ESP32 + DHT11 on GPIO 4. Read temperature and humidity every 2 seconds and print to Serial. Provide documentation and missing libraries.**
...
## Project: Generate firmware for ESP32 + DHT11 on GPIO 4. Read temperature and humidity every 2 seconds and print to Serial. Provide documentation and missing libraries.
...
|---------------|----------|--------|
| dhtPin | GPIO4 | const declaration |
