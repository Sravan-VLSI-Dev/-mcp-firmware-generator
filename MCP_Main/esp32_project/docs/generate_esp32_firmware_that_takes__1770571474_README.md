# Generate ESP32 firmware that takes Serial input commands: LED_ON, LED_OFF, STATUS. LED is GPIO 2. STATUS prints uptime and last command. Provide docs.

**Auto-generated Documentation**  
*Generated: 2026-02-08 22:56:59*
...
This embedded systems project implements: **Generate ESP32 firmware that takes Serial input commands: LED_ON, LED_OFF, STATUS. LED is GPIO 2. STATUS prints uptime and last command. Provide docs.**
...
## Project: Generate ESP32 firmware that takes Serial input commands: LED_ON, LED_OFF, STATUS. LED is GPIO 2. STATUS prints uptime and last command. Provide docs.
...
|---------------|----------|--------|
| LED_PIN | GPIO2 | #define directive |
...
- `handleCommand()` - Helper function
- `printStatus()` - Helper function
