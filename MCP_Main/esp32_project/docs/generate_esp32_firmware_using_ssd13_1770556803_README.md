# Generate ESP32 firmware using SSD1306 OLED (128x64 I2C). Display "Hello MCP" and show uptime seconds. Use SDA=21 and SCL=22. Provide wiring and documentation.

**Auto-generated Documentation**  
*Generated: 2026-02-08 18:52:42*
...
This embedded systems project implements: **Generate ESP32 firmware using SSD1306 OLED (128x64 I2C). Display "Hello MCP" and show uptime seconds. Use SDA=21 and SCL=22. Provide wiring and documentation.**
...
## Project: Generate ESP32 firmware using SSD1306 OLED (128x64 I2C). Display "Hello MCP" and show uptime seconds. Use SDA=21 and SCL=22. Provide wiring and documentation.
...
|---------------|----------|--------|
| SDA | GPIO21 | const declaration |
| SCL | GPIO22 | const declaration |
| DISPLAY_WIDTH | GPIO128 | const declaration |
| DISPLAY_HEIGHT | GPIO64 | const declaration |
