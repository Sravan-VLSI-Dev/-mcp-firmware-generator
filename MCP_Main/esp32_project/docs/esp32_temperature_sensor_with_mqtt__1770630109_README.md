...
This embedded systems project implements: ** ESP32 temperature sensor with MQTT publishing and OLED status display**
...
## Project:  ESP32 temperature sensor with MQTT publishing and OLED status display
...
|---------------|----------|--------|
| dhtPin | GPIO2 | const declaration |
| oledSCL | GPIO5 | const declaration |
| oledSDA | GPIO4 | const declaration |
...
This project requires **4** external libraries.
...
```bash
pio lib install "Adafruit_SSD1306.h"
pio lib install "ESP8266WiFi.h"
pio lib install "MQTTClient.h"
pio lib install "DHTesp.h"
```
...
2. Search and install each library:
   1. Search: `Adafruit_SSD1306.h`
   2. Search: `ESP8266WiFi.h`
   3. Search: `MQTTClient.h`
   4. Search: `DHTesp.h`
